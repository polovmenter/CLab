...
void task117() {
	...
	printf("%f фунтов = %f киллограмм", pounds, kilograms);
}
...
void task119() {
	...
	printf("������� �������������� �� ��������� %f � %f = %f", width, height, area);
}
...
void task1110() {
	...
	printf("������� ��������������� ������������ � ������� %f � ���������� %f = %f", height, footingLength, area);
}
...
void task1111() {
	...
	printf("������� �������� � ����������� %.3f � %.3f � ������� %.3f = %.3f", footing1, footing2, height, area);
}
...
void task1112() {
	...
	printf("��������� %d ��������, %d ������� � %d ���������� = %.2f", copybookAmount, coverAmount, penAmount, result);
}
...
void task1113() {
	...
	printf("��������� %d �������, %d ������� � %d ������ ������ = %.2f", tomatoAmount, cucumberAmount, dillAmount, result);
}
